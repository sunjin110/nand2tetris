...
then
	...
	echo Compiling "$arg1"
	java -classpath "${CLASSPATH}:test_bin/classes:test_bin/lib/Hack.jar:test_bin/lib/Compilers.jar" Hack.Compiler.JackCompiler "$arg1"
    # java -classpath "${CLASSPATH}:../tools/bin/classes:bin/lib/Hack.jar:bin/lib/Compilers.jar" Hack.Compiler.JackCompiler "$arg1"
fi
